...
TRACKED_ENTITIES: dict[str, list[str]] = {
    ...
    "Valeo":           ["valeo"],
    "Aptiv":           ["aptiv"],
    "ZF":              ["zf friedrichshafen", " zf "],
    "Magna":           ["magna international", "magna "],
    # ── 자동차·로봇 SoC ──────────────────────────────────────
    ...
    "Agibot":          ["agibot", "智元"],
    "Fourier Intelligence": ["fourier intelligence", "傅利叶"],
    "UBTECH":          ["ubtech"],
    "Xiaomi Robotics": ["xiaomi robot", "cybertone", "cyberone"],
    # ── 메모리·스토리지 ────────────────────────────────────────
    "Samsung":         ["samsung"],
